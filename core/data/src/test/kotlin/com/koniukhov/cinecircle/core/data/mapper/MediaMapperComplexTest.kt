...
import com.koniukhov.cinecircle.core.network.model.*
...
class MediaMapperComplexTest {
    ...
    fun `MovieDetailsDto toDomain should map all fields correctly`() {
        ...
        val companyDto = ProductionCompanyDto(id = 1, logoPath = "/logo.jpg", name = "Warner", originCountry = "US")
        val countryDto = ProductionCountryDto(countryCode = "US", name = "United States")
        val languageDto = LanguageDto(englishName = "English", languageCode = "en", name = "English")
        val collectionDto = MovieCollectionDto(id = 10, name = "Collection", posterPath = "/p.jpg", backdropPath = "/b.jpg")
    ...
    fun `TvSeriesDetailsDto toDomain should map all fields correctly`() {
        ...
        val creatorDto = CreatorDto(id = 1, creditId = "c1", name = "Creator", gender = 1, profilePath = "/c.jpg")
        val networkDto = NetworkDto(name = "HBO", id = 1, logoPath = "/hbo.jpg", originCountry = "US")
