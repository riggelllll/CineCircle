package com.koniukhov.cinecirclex.core.ui.adapter
...
import com.koniukhov.cinecirclex.core.design.databinding.ItemMediaListBinding
...
import com.koniukhov.cinecirclex.core.ui.utils.MediaDiffCallback
    ...
    override fun onBindViewHolder(holder: MediaViewHolder, position: Int) {
        ...
        with(holder.binding) {
            ...
            if (mediaItem.posterPath.isNotEmpty()) {
                poster.load(POSTER_MEDIUM.format(mediaItem.posterPath)) {
