package com.koniukhov.cinecirclex.feature.ai.recommendations.ui
...
import com.koniukhov.cinecirclex.feature.ai_recommendations.R as aiR
import com.koniukhov.cinecirclex.feature.ai.recommendations.viewmodel.MovieRecommendationViewModel
import com.koniukhov.cinecirclex.feature.ai_recommendations.databinding.FragmentRecommendationsBinding
...
import com.koniukhov.cinecirclex.core.ui.adapter.MediaListAdapter
...
class RecommendationsFragment : BaseFragment<FragmentRecommendationsBinding, MovieRecommendationViewModel>() {
            ...
            viewModel.loadedCount.collectLatest { loaded ->
                if (viewModel.isLoading.value) {
                    if (total > 0) {
                        ...
                        binding.loadingProgressCount.text = getString(aiR.string.loading_progress, loaded, total)
                    } else {
    ...
    private fun showErrorDialog() {
        ...
        MaterialAlertDialogBuilder(requireContext())
            .setTitle(aiR.string.recommendations_error_title)
            .setMessage(aiR.string.recommendations_error_message)
            .setCancelable(false)
            .setNegativeButton(aiR.string.exit) { _, _ ->
                isErrorDialogShowing = false
                requireActivity().finish()
            }
            .setPositiveButton(aiR.string.retry) { _, _ ->
                isErrorDialogShowing = false
                binding.loadingStateLayout.visibility = View.VISIBLE
                startRecommendationCalculation()
            }
