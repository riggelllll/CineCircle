...
import com.koniukhov.cinecirclex.core.common.navigation.NavArgs.mediaListUri
...
import com.koniukhov.cinecirclex.feature.home.R
import com.koniukhov.cinecirclex.feature.home.adapter.GenreUiAdapter
import com.koniukhov.cinecirclex.feature.home.databinding.FragmentMoviesHomeBinding
import com.koniukhov.cinecirclex.feature.home.ui.state.MoviesUiState
import com.koniukhov.cinecirclex.feature.home.ui.viewmodel.HomeViewModel
...
class MoviesHomeFragment : BaseFragment<FragmentMoviesHomeBinding, HomeViewModel>() {
    ...
    private fun notifyNetworkError() {
        (parentFragment as? NetworkErrorListener)?.onNetworkError(HomeFragment.FRAGMENT_TYPE_MOVIES)
    }
