...
import com.koniukhov.cinecirclex.core.design.util.getMoviesGenreUiList
import com.koniukhov.cinecirclex.core.design.util.getTvSeriesGenreUiList
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                _tvSeriesUiState.value = _tvSeriesUiState.value.copy(
                    isLoading = false,
                    error = e.message ?: "Unknown error",
                    airingTodayTvSeries = emptyList(),
                    onTheAirTvSeries = emptyList(),
                    trendingTvSeries = emptyList(),
